...
try {//Afficher les erreurs
    ...
    //Prepared statement
    $sql = "INSERT INTO exercices (date, type, duree, description, difficulte) VALUES (:date, :type, :duree, :description, :difficulte)";
...
// TODO: try and catch pour toutes les requetes